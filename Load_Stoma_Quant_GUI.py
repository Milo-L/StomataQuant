...
from PyQt5.QtCore import QPointF, QRect, QRectF, Qt, pyqtSignal, QThread
...
from Stoma_Quant_GUI import MainWindow
    ...
    def inference_ABorAD(self):
        try:
            ...
            if reply == QMessageBox.Yes:
                ...
                # 创建并启动线程
                self.aborad_thread = ABorADInferenceThread(cls_model_path, file_path, self)
...
if __name__ == "__main__":
    ...
    app_icon = QtGui.QIcon("ICON.png")  # 使用启动画面作为图标
