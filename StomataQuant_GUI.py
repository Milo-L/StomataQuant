...
class MainWindow(QMainWindow):
    def setupUi(self, MainWindow):
     ...
     # 确保工具栏在菜单栏下方
        ...
        self.actionSeeHelp = QtWidgets.QAction(MainWindow)
        self.actionSeeHelp.setObjectName("actionSeeHelp")
        ...
        self.menuMoreInfo.addAction(self.actionSeeHelp)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionSeeHelp.setText(_translate("MainWindow", "Instruction Manual"))
